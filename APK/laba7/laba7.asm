...
lim dw 0 ; предел
base_1 dw 0 ; база младшая часть3
base_m db 0 ; база средняя часть
...
base_h db 0 ; база старшая часть
descr ends   

gate struc ; дескриптор шлюза
offs_1 dw 0 ; смещение младшая часть
sel dw 16 ; селектор сегмента
cntr db 0 ; счетчик (000, 5 бит счетчика)
dtype db 8Eh ; атрибут == атрибуту дескриптора сегмента
offs_h dw 0 ; смещение старшая часть
gate ends  
...
; idt - таблица дескрипторов исключений
idt label word
db 32 dup ( 8 dup (0))
...
time_buffer_pos dw 2240
scan_msg db 'S', 1Eh, 'c', 1Eh, 'a', 1Eh, 'n', 1Eh, ':', 1Eh, ' ', 1Eh
scan_buffer db '0', 1Eh, '0', 1Eh
scan_buffer_line_size equ 8
scan_buffer_pos dw 1920
scancode db 0A9h
sixteen db 16
ten dw 10
sign dw ?
